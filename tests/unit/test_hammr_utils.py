...
class TestFiles(unittest.TestCase):
    ...
    def test_pythonObjectFromYamlParsingShouldBeTheSameAsJsonParsing(self):
        #Given
        jsonPath = "../integration/data/test-parsing.json"
        yamlPath = "../integration/data/test-parsing.yml"
        #When
    ...
    def test_check_extension_and_validate_json(self, mock_method):
        ...
        jsonPath = "test.json"
        #When
        hammr_utils.check_extension_and_validate(jsonPath)
        #Then
    ...
    def test_check_extension_and_validate_yaml(self, mock_method):
        ...
        yamlPath = "test.yml"
        #When
        hammr_utils.check_extension_and_validate(yamlPath)
        #Then
