...
Once the cloud account is created, you can safely reference the cloud credentials in all the template files by using the account name, in this example: ``James AWS Account``

Now use this account to build a machine image for Amazon EC2. Open up the file ``nginx-template.json``, and provide the following content:
